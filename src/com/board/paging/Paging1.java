...
public class Paging1 {
	...
	public Paging1(int currentPage, int totalCount, int blockCount,
	...
	public Paging1(String keyField, String keyWord, int currentPage,
	...
	public Paging1(String keyField, String keyWord, int currentPage,
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				this.pagingHtml.append(i);
				this.pagingHtml.append(addKey + "' id='page' style='text-decoration: none; font-size:12px;'>");
				this.pagingHtml.append(i);
				this.pagingHtml.append("</a>");
			}
			this.pagingHtml.append("&nbsp;");
